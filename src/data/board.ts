...
export const BOARD_TILES: TileDefinition[] = [
  { id: "start", type: "start", name: "City Gate", icon: "redo" },
  {
    id: "alabayir",
    type: "property",
    name: "Alabayir Village",
  ...
  { id: "heirloom-chest-1", type: "chest", name: "Heirloom Chest", icon: "inventory_2" },
  {
    id: "yagcilar",
    type: "property",
    name: "Yagcilar Village",
    color: COLOR_GROUPS.brown,
    group: "brown",
    price: 60,
    rent: 4,
  ...
  { id: "village-tax", type: "tax", name: "Village Fund", icon: "payments", price: 200 },
  {
    id: "heritage-rail",
    type: "railway",
    name: "Heritage Rail",
  ...
  { id: "chance-mist-1", type: "chance", name: "Chance Card", icon: "help" },
  {
    id: "derekoy",
    type: "property",
    name: "Derekoy",
  ...
  { id: "just-visiting", type: "jail", name: "City Hall", icon: "gavel" },
  {
    id: "golcuk",
    type: "property",
    name: "Golcuk",
  ...
  { id: "heirloom-chest-2", type: "chest", name: "Heirloom Chest", icon: "inventory_2" },
  {
    id: "uzungol",
    type: "property",
    name: "Uzungol",
  ...
  { id: "free-parking", type: "parking", name: "Free Parking", icon: "local_parking" },
  {
    id: "camlibel",
    type: "property",
    name: "Camlibel",
  ...
  { id: "chance-mist-2", type: "chance", name: "Chance Card", icon: "help" },
  {
    id: "ortakoy",
    type: "property",
    name: "Ortakoy",
  ...
  { id: "goto-jail", type: "gotojail", name: "Go to City Hall", icon: "front_hand" },
  {
    id: "yesilkoy",
    type: "property",
    name: "Yesilkoy",
  ...
  { id: "heirloom-chest-3", type: "chest", name: "Heirloom Chest", icon: "inventory_2" },
  {
    id: "sarikoy",
    type: "property",
    name: "Sarikoy",
  ...
  { id: "chance-mist-3", type: "chance", name: "Chance Card", icon: "help" },
  {
    id: "lazova",
    type: "property",
    name: "Lazova",
